...
<div class="row" style="margin-left:70px">
		...
		<div class="profile-container">
			<section>
				<div class="profile-info">
					<div class="avatar">
						<img src="/image/${admin.image_admin}" alt="User Avatar">
					</div>
					<div class="user-details">
						<h2>${admin.lastname_admin} ${admin.firstname_admin}</h2>
						<p>${admin.email_admin}</p>
						<p>${admin.sdt_admin}</p>
						<p>${admin.registerdate_admin}</p>
					</div>
				</div>
			</section>
	...
	<div class="col-1" style="background-color:#2B3035;height:650px">
		<!-- Nội dung của phần 2 -->
		<h3>Cấp:</h3>
